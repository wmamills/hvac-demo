...
-append "root=/dev/vda2 console=ttyAMA0 earlycon autorun=./demo-qemu-proxy/${SHORT_NAME}-kvm.sh"
)

# use Xen and Dom0 boot
XBA="root=/dev/vda2 console=hvc0 earlyprintk=xen autorun=./demo-qemu-proxy/${SHORT_NAME}-xen.sh"
QEMU_XEN=(
-kernel "${IMAGES}/${XEN}"
